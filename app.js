...
function calcular(){
 ...
 const gmC=+gmCasa.value, gsC=+gsCasa.value, gmF=+gmFora.value, gsF=+gsFora.value;
 const fC=+formaCasa.value, fF=+formaFora.value;
 ...
 let odds = {
   ...
   over:+oddOver.value, under:+oddUnder.value,
   btts:+oddBTTS.value
 };
 ...
 Over 2.5: ${values.over.toFixed(1)}%<br>
 Under 2.5: ${values.under.toFixed(1)}%<br>
